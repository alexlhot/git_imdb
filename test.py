...
def compare_cast(movies: Annotated[list[str], typer.Option(..., '-m')]):
    ...
    create_tree_cast(resultats, lambda m: m)
...
if __name__ == '__main__':
    #app()
    #search_actors(['peter', 'stormare', 'chloe', 'moretz', 'lance', 'reddick', 'nicolas', 'cage', 'lance', 'reddick', 'common']) # ok
    #filmo('keanu reeves') #ok
    #compare_cast(['goodfellas', 'brazil', 'casino']) #ok
